...
import { AgentToolCard } from "@/components/toolkit";
        ...
        >
          {({ part, children }) => {
            switch (part.type) {
              ...
              case "tool-call": {
                if (part.toolName === "run_claude_code" || part.toolName === "run_codex") {
                  const provider = part.toolName === "run_claude_code" ? "claude" : "codex";
                  return (
                    <AgentToolCard
                      provider={provider}
                      args={part.args as { prompt?: string; workspace?: string } | undefined}
